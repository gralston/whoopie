...
try
{
    ...
    //Creating a new record (createAction)
        ...
        angellog("payouts table: create entry: " . mysqli_escape_string($con, $updateQ));
    ...
    else if($_GET["action"] == "update")
    {
        ...
        angellog("payouts table: update entry: " . mysqli_escape_string($con, $updateQ));
        //Return result to jTable
        $jTableResult = array();
        $jTableResult['Result'] = "OK";
        print json_encode($jTableResult);
    ...
    else if($_GET["action"] == "delete")
    {
        ...
        angellog("payouts table: delete entry: id=" . $_POST["id"]);
