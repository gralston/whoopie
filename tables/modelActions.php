...
try
{
    ...
    if($_GET["action"] == "list") {
        ...
        */
        ...
        if ($_POST['name'] != NULL) {
            ...
            $wherePart = sprintf(" WHERE name LIKE '%%%s%%' ", $n );
            $needWhere = false;
        }
    ...
    //Creating a new record (createAction)
        ...
        angellog("Model table: create entry: " . mysqli_escape_string($con, $updateQ));
    ...
    else if($_GET["action"] == "update")
    {
        ...
        angellog("Model table: update entry: " . mysqli_escape_string($con, $updateQ));
        //Return result to jTable
        $jTableResult = array();
        $jTableResult['Result'] = "OK";
        print json_encode($jTableResult);
    ...
    else if($_GET["action"] == "delete")
    {
        ...
        angellog("Model table: delete entry: id=" . $_POST["id"]);
