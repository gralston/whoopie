...
try
{
    ...
    if($_GET["action"] == "list") {
        angellog("angelinvest table: list");
    ...
    //Creating a new record (createAction)
        ...
        angellog("angelinvests table: create entry: " . mysqli_escape_string($con, $updateQ));
    ...
    else if($_GET["action"] == "update")
    {
        ...
        angellog("angelinvests table: update entry: " . mysqli_escape_string($con, $updateQ));
        //Return result to jTable
        $jTableResult = array();
        $jTableResult['Result'] = "OK";
        print json_encode($jTableResult);
    ...
    else if($_GET["action"] == "delete")
    {
        ...
        angellog("angelinvests table: delete entry: id=" . $_POST["id"]);
